  ...
  return (
    <section>
      ...
      <h1>PRIVACY POLICY</h1>
        ...
        <div>To process any transactional or ongoing payments, and</div>
        <div>To deliver products and/or services to you.</div>

        <h3>4. INTERNATIONAL TRANSFERS OF PERSONAL INFORMATION</h3>
        <div>The personal information we collect is stored and processed in Canada, or where we or our partners, affiliates and third-party providers maintain facilities. By providing us with your personal information, you consent to the disclosure to these overseas third parties.</div>
        ...
        <h3>5. YOUR RIGHTS AND CONTROLLING YOUR PERSONAL INFORMATION</h3>
        ...
        <div>Notification of data breaches: We will comply with laws applicable to us in respect of any data breach.</div>
        ...
        <h3>6. COOKIES</h3>
        <div>We use “cookies” to collect information about you and your activity across our site. A cookie is a small piece of data that our website stores on your computer, and accesses each time you visit, so we can understand how you use our site. This helps us serve your content based on the preferences you have specified. Please refer to our Cookie Policy for more information.</div>

        <h3>7. BUSINESS TRANSFERS</h3>
